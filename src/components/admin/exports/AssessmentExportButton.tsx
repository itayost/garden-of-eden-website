...
export function AssessmentExportButton({
  ...
  const handleExport = () => {
    ...
    const csvData = assessments.map((a) => ({
      ...
      [ASSESSMENT_LABELS_HE.kick_power_right_foot]: a.kick_power_right_foot ?? "",
      [ASSESSMENT_LABELS_HE.kick_power_left_foot]: a.kick_power_left_foot ?? "",
      [ASSESSMENT_LABELS_HE.kick_power_machine_pct]: a.kick_power_machine_pct ?? "",
