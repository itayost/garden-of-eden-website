  ...
  return (
    <section id="testimonials" className="py-20 bg-[#1a1a1a]">
      <div className="container mx-auto px-6">
        ...
        >
          <span className="text-sm text-[#CDEA68] mb-2 block">המלצות</span>
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="bg-white/5 backdrop-blur-sm rounded-3xl p-8 border border-white/10 hover:border-[#CDEA68]/30 transition-colors"
            >
              {/* Quote icon */}
