...
const METRIC_ROWS: { key: keyof PlayerAssessment; label: string }[] = [
  ...
  { key: "kick_power_right_foot", label: ASSESSMENT_LABELS_HE.kick_power_right_foot },
  { key: "kick_power_left_foot", label: ASSESSMENT_LABELS_HE.kick_power_left_foot },
  { key: "kick_power_machine_pct", label: ASSESSMENT_LABELS_HE.kick_power_machine_pct },
