                  ...
                  <div key={goal.id} className="relative group">
                    ...
                    >
                      ...
                      <Button
                        ...
                        variant="destructive"
                        size="icon"
                        className="h-8 w-8 opacity-100 md:opacity-0 md:group-hover:opacity-100 md:focus-visible:opacity-100 md:group-focus-within:opacity-100 transition-opacity"
                  ...
                  <div key={goal.id} className="relative group">
                    ...
                    >
                      ...
                      <Button
                        ...
                        variant="ghost"
                        size="icon"
                        className="h-8 w-8 opacity-100 md:opacity-0 md:group-hover:opacity-100 md:focus-visible:opacity-100 md:group-focus-within:opacity-100 transition-opacity text-muted-foreground hover:text-destructive"
                        disabled={isDeleting && deletingGoalId === goal.id}
                        aria-label="מחיקת יעד"
                      >
                        <Trash2 className="h-4 w-4" aria-hidden="true" />
