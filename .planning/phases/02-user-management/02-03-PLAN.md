...
must_haves:
  ...
  artifacts:
    - path: "src/app/admin/users/page.tsx"
      provides: "Admin users list page with data table"
      min_lines: 60
...
<objective>
Build the data table for the admin users list with search, filter, and pagination.

Purpose: Replace basic table with full-featured TanStack Table supporting real-time search, filters persisted in URL, and paginated navigation.

Output:
- Refactored users list page with TanStack Table
- Reusable table components (columns, toolbar, pagination)
</objective>
